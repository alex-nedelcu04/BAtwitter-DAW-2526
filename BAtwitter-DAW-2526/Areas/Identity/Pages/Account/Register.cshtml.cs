    ...
    public partial class RegisterModel : PageModel
    {
            ...
            string defaultLink)
        {
            ...
            if (uploadFile != null && uploadFile.Length > 0)
            {
                ...
                var directoryPath = Path.Combine(_env.WebRootPath, "Resources", "Users", userId);
                Directory.CreateDirectory(directoryPath);
                ...
                var databaseFileName = "/Resources/Users/" + userId + "/" + safeName;
            ...
            if (!string.IsNullOrWhiteSpace(existingLink) && existingLink.StartsWith(TempUploadsWebPathPrefix, StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (System.IO.File.Exists(tempPath))
                {
                    ...
                    return "/Resources/Users/" + userId + "/" + destName;
                }
            }
